...
describe('Function exports', () => {
    ...
    it('should export getLikes function', () => {
        expect(typeof api.getLikes).toBe('function');
    });

    it('should export getRepostedBy function', () => {
        expect(typeof api.getRepostedBy).toBe('function');
    });

    it('should export getSuggestions function', () => {
        expect(typeof api.getSuggestions).toBe('function');
    });

    it('should export listNotifications function', () => {
        expect(typeof api.listNotifications).toBe('function');
    });

    it('should export countUnreadNotifications function', () => {
        expect(typeof api.countUnreadNotifications).toBe('function');
    });

    it('should export updateSeenNotifications function', () => {
        expect(typeof api.updateSeenNotifications).toBe('function');
    });

    it('should export resolveHandle function', () => {
        expect(typeof api.resolveHandle).toBe('function');
    });

    it('should export updateHandle function', () => {
        expect(typeof api.updateHandle).toBe('function');
    });
});
